var _azerionBuildVersion = "tc-3";
var _azerionIntegration = {
    "gdId": "aca5680be0c143a69c6a28221afc330d",
    "rtgEnabled": false,
    "lbEnabled": false,
    "fbType": "dummy",
    "alxType": "none",
    ...
    "build": {
        "version": "tc-3",
        "timeStamp": 1686816387276,
        "h": "3f0f5e0d"
    },
    "gameTitle": "Bubble Shooter Story"
};
var playBtn = true;
var fbrqBD = 8;
var fbrqLA = true;
...
function(t, e) {
    ...
    t(function(t, I) {
        ...
        var w, o, v, b, _, A, D, x, S, T, O, P, E, C, k, B, L, M, N, R;
    ...
    o.BrandingDomain = void 0, (P = o.BrandingDomain || (o.BrandingDomain = {}))[P.Neutral = 0] = "Neutral", P[P.Yepi = 1] = "Yepi", P[P.Spele = 2] = "Spele", P[P.Funnygames = 3] = "Funnygames", P[P.Kizi = 4] = "Kizi", P[P.PlayCell = 5] = "PlayCell", P[P.GameCell = 6] = "GameCell", P[P.Bild = 7] = "Bild", P[P.AGame = 8] = "AGame", P[P.Admeen = 9] = "Admeen", P[P.PlayTime = 10] = "PlayTime", P[P.Zigiz = 11] = "Zigiz", p.isBip = function() {
    ...
    function p() {}
    o.UtmTargets = void 0, (P = o.UtmTargets || (o.UtmTargets = {}))[P.splashscreen = 0] = "splashscreen", P[P.logo = 1] = "logo", P[P.facebook = 2] = "facebook", P[P.twitter = 3] = "twitter", P[P.playstore = 4] = "playstore", P[P.appstore = 5] = "appstore", P[P.more_games = 6] = "more_games", P[P.download_game = 7] = "download_game", P[P.walkthrough = 8] = "walkthrough", P[P.disclaimer = 9] = "disclaimer", P[P.highscores = 10] = "highscores", m.getProtocol = function(t) {
        return t ? "https://" : "//"
                ...
                1: [function(t, G, j) {
                    ! function() {
                        var c, n, u, h, p, t, f, s, d, l, m, o, r, a, i, g, e, y, w = this || Function("return this")(),
                            ...
                            }), "function" == typeof SHIFTY_DEBUG_NOW && (w.timeoutHandler = O), "object" == typeof j ? G.exports = E : void 0 === w.Tweenable && (w.Tweenable = E), E);
    ...
    o.Branding = _, o.DebugTools = S, o.Domain = i, o.Hosts = h, o.SplashLoader = P, o.Utils = D, Object.defineProperty(o, "__esModule", {
        value: !0
    })
});