    ...
    var __webpack_modules__ = {
                ...
                Object.create && (a.prototype = Object.create(null), (new a).__proto__ || (n = !1)), o.prototype.eventNames = function() {
                    ...
                    if (c.fn) {
                        ...
                        for (d = 0; d < p; d++) switch (c[d].once && this.removeListener(e, c[d].fn, void 0, !0), u) {
                            ...
                            default:
                                if (!l)
                                    for (g = 1, l = new Array(u - 1); g < u; g++) l[g - 1] = arguments[g];
            ...
            5215: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.printS = t.sglogs = t.isIpad = t.isIphone = t.isFireFoxOnAndroid = t.isSamsungInternetOnAndroidTab = t.isSamsungInternetOnAndroidMobile = t.isAndroidTab = t.isAndroidMobile = t.isAndroidDevice = t.isMobileOrTab = t.getOrientation = t.mailToFunction = t.showSnackBar = t.copyFunction = t.pickValid = t.nulOrUnd = void 0;
                const r = a(n(8744)),
                    i = n(6618);
                ...
                function o(e) {
                    document.getElementById("snackbar") && document.body.removeChild(document.getElementById("snackbar"));
                    const t = document.createElement("div");
                    t.id = "snackbar", document.body.appendChild(t), t.innerHTML = e, t.className = "show", setTimeout((function() {
                        t.className = t.className.replace("show", "")
                    }), 3e3)
                }
                t.nulOrUnd = s, t.pickValid = function(e, t) {
                    return s(e) ? t : e
                }, t.copyFunction = async function(e, t) {
                    const n = r.default.commsManager.getLanguage(i.wrapperLanguages),
                        a = document.createElement("textarea");
                    a.value = t, document.body.prepend(a), a.select();
                    try {
                        document.execCommand("copy"), o(`${e} ${i.TEXTS[n].copy_message}`)
                    } catch (t) {
                        o(`${i.TEXTS[n].failed_message} ${e}, ${i.TEXTS[n].try_again_message}`)
                    }
                    document.body.removeChild(a)
                }, t.showSnackBar = o, t.mailToFunction = function() {
                    const e = r.default.commsManager.getLanguage(i.wrapperLanguages);
                    let t = r.default.instance.platformDefaults.supportEmail,
                        n = navigator.userAgent,
                        a = r.default.instance.getPlayerID(),
                        s = r.default.instance.config.gameTitle,
                        o = `${i.TEXTS[e].game_name}: ${s}, ${i.TEXTS[e].player_id}: ${a}`,
                        l = `${i.TEXTS[e].user_agent}: ${n}\r\n\n                ${i.TEXTS[e].query_string}\r\n`;
                    l = encodeURIComponent(l);
                    try {
                        window.open(`mailto:${t}?subject=${o}&body=${l}`)
                    } catch (e) {
                        console.log(e)
                    }
                    ...
                    console.log(e ? "Optional logs activated" : "Optional logs deactivated"), t.sglogs = e
                }, t.printS = function(e) {
                    t.sglogs && console.log(e)
                }
            },
            8744: function(e, t, n) {
                var a = this && this.__importDefault || function(e) {
                ...
                class y extends r.default {
                    constructor() {
                        super(), this.isReady = !1, this.gameStarted = !1, this.interface = new r.default, this.trackingEmitter = new r.default, s.default.setupUIStyle()
                    }
                    static get instance() {
                        return void 0 === y._instance ? y._instance = new y : y._instance
                    }
                    static isPlatformSupported() {
                        return y.commsManager.isPlatformSupported
                    }
                    getPlayerID() {
                        return y.commsManager.playerID
                    }
                    async init(e) {
                        ...
                        return this.commsManager.checkPlatformSupport(t), await this.storageManager.initialize(this.config), this.createInterface(e.interface), await this.initAds(), window.sgWrapper = this, this.config.inAppPurchase && await this.initIAP(), this.createUI(e), this.initOnceAllReady(), Promise.resolve()
                    }
                    onAllReady() {
                        this.isReady = !0, this.checkForRemoteJS(), window.onWrapperReady && (window.onWrapperReady(), this.emit(l.default.READY))
                    }
                    initOnceAllReady() {
                        let e = !1;
                        const t = () => {
                    ...
                    createUI(e) {
                        ...
                        })), this.countdownTag = new p.default, y.instance.platformDefaults.useFakeAdLoader && (this.adLoadBg = new f.default);
                        const t = (0, m.getConfigOptionAny)("lockOrientation");
                        t !== A.OrientationLock.NONE && null !== t && new E.default, window.printsgstatus = () => {
                            y.commsManager.logDebugStatus()
                        }
                    }
                    async initAds() {
                    ...
                    async onStartGame() {
                        ...
                        try {
                            ...
                            console.log(e), this.commsManager.checkPlatformSupport(e)
                        }
                    }
                    createInterface(e) {
                        switch (e) {
                            case i.InterfaceType.SGSDK:
                                new g.default(this.interface);
                                break;
                    ...
                    applyWrapperOptions() {
                        if (void 0 !== this.config.options) {
                            ...
                            this.config.options.reloadOnFold && e && new _.default
                        }
                    }
                    logBuild(e) {
                    ...
                    static get placementIDs() {
                        return y.instance.placementIDs
                    }
                    static get commsManager() {
                        return y.instance.commsManager
                    }
                    static get adManager() {
                        return y.instance.adManager
                    }
                    static get iapManager() {
                        return y.instance.iapManager
                    }
                    static get interface() {
                        return y.instance.interface
                    }
                    static get config() {
                        return y.instance.config
                    }
                    static get storageManager() {
                        return y.instance.storageManager
                    }
                    static get leaderboards() {
                        return y.instance.leaderboards
                    }
                    static get trackingEmitter() {
                        return y.instance.trackingEmitter
                    }
                    static get sdkHandler() {
                        return y.instance.sdkHandler
                    }
                    static set sdkHandler(e) {
                        y.instance.sdkHandler = e
                    }
                }
                t.default = y, y.version = "2.7.37"
            },
            939: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                        value: !0
            ...
            388: (e, t) => {
                ...
                class n {}
                t.default = n, n.imagePath = "", n.platformConfig = "platform-config.json", n.ratingImage = n.imagePath + "grac_kr_rating_all.png", n.softgamesLogo = n.imagePath + "softgames_logo.png", n.supportPopupBG = n.imagePath + "support_popup.png", n.supportPopupCloseBtn = n.imagePath + "support_close_button.png", n.support_green_button = n.imagePath + "support_green_button.png", n.support_blue_button = n.imagePath + "support_blue_button.png", n.support_darkened_background_1 = n.imagePath + "support_darkened_background_1.png", n.support_darkened_background_2 = n.imagePath + "support_darkened_background_2.png", n.support_copy_icon = n.imagePath + "support_copy_icon.png", n.firebaseConfig = "firebaseConfig.json"
            },
            5028: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                        value: !0
            ...
            2665: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    ...
                    function(e) {
                        e.AD_ERROR = "AD_ERROR", e.AD_LOADED = "AD_LOADED", e.AD_START = "AD_START", e.AD_SKIP = "AD_SKIP", e.AD_COMPLETE = "AD_COMPLETE", e.AD_CLOSE = "AD_CLOSE", e.REWARDED_AD_CLOSE = "REWARDED_AD_CLOSE", e.INTERSTITIAL_AD_REQUESTED = "INTERSTITIAL_AD_REQUESTED", e.REWARDED_AD_REQUESTED = "REWARDED_AD_REQUESTED", e.AD_REQUESTED = "AD_REQUESTED"
            ...
            8258: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                        value: !0
                    }), t.GameSceneEvent = void 0,
                    function(e) {
                        e.SCENE_CHANGE = "GameSceneEvent_sceneChange"
                    }(t.GameSceneEvent || (t.GameSceneEvent = {}))
            },
            9250: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                        value: !0
                    ...
                    function(e) {
                        e.IAP_READY = "onIAPReady", e.IAP_PURCHASED = "onIAPPurchase", e.IAP_FAILED = "onIAPFailed"
            ...
            875: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    ...
                    function(e) {
                        e.LOGIN_STATUS_CHANGE = "LOGIN_STATUS_CHANGE"
                    }(t.UserEvent || (t.UserEvent = {}))
            },
            6430: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
            ...
            973: function(e, t, n) {
                ...
                t.getConfigOption = function(e) {
                    ...
                    return r.default.config.options && r.default.config.options[e] || null
                }
            },
            308: function(e, t, n) {
                var a = this && this.__importDefault || function(e) {
                ...
                t.default = class {
                            ...
                            t = window.setInterval((() => {
                                (() => {
                                    if (window.sgLeaderboards) {
                                        ...
                                        const n = window.sgLeaderboards.getHandler(s.default.config);
                                        e(n)
                                    }
                                })()
                            }), 100)
                    ...
                    async getTrackingHandler() {
                        let e;
                        return new Promise(((t, n) => {
                            e = window.setInterval((() => {
                                window.sgTrack && (window.clearInterval(e), t(window.sgTrack))
                            }), 100)
                        }))
                    }
                            ...
                            e = window.setInterval((() => {
                                (() => {
                                    if (window.sgIAP) {
                                        ...
                                        const n = window.sgIAP.getHandler(s.default.config);
                                        t(n)
                                    }
                                })()
                            }), 100)
            ...
            9284: function(e, t, n) {
                ...
                class f extends p.default {
                    async createWrapper(e) {
                        super.createWrapper(e), g.default.instance.config = e, g.default.instance.platformDefaults = new c.default, e.platform = r.PlatformType.AZERION, g.default.instance.storageManager = new d.default, g.default.instance.commsManager = new o.default, g.default.instance.adManager = new s.default, g.default.instance.placementIDs = {
                            rewarded: g.default.config.gameID,
                            interstitial: g.default.config.gameID
                        }, g.default.instance.iapManager = new l.default, g.default.instance.SGPreloader = new u.default(!1), g.default.instance.init(e), !0 === e.leaderboardSupport && (g.default.instance.leaderboards = await this.getLeaderboardHandler(i.LeaderboardTypes.FIREBASE)), g.default.instance.onStart()
                    }
                }
                t.default = f, new f
            },
            2673: function(e, t, n) {
                ...
                class f extends o.default {
                    constructor(e) {
                        super(e), this.player = new c.default, this.payments = new d.default, this.tournament = new u.default, this.context = new l.default, this.community = new g.default, this.graphApi = new p.default, window.FBInstant = this
                    }
                    initializeAsync() {
                        return r.default.instance.supportedLanguages = ["en"], Promise.resolve()
                    }
                    startGameAsync() {
                        return this.interfaceRef.emit(i.InterfaceEvent.LOAD_PROGRESS, {
                            progress: 101
                        }), r.default.commsManager.startGame(), Promise.resolve()
                    }
                    setLoadingProgress(e) {
                        const t = e || 0;
                        r.default.commsManager.setLoadingProgress(t), e >= 100 && this.interfaceRef.emit(i.InterfaceEvent.LOADED)
                    }
                    onPause(e) {}
                    getLocale() {
                        return r.default.commsManager.getLanguage()
                    }
                    getPlatform() {
                        return null
                    }
                    ...
                    async getInterstitialAdAsync(e) {
                        return Promise.resolve({
                            ...
                            showAsync: () => r.default.adManager.showInterstitialAd(),
                            getPlacementID: () => r.default.placementIDs.interstitial
                        })
                    }
                    async getRewardedVideoAsync(e) {
                        return Promise.resolve({
                            ...
                            showAsync: () => new Promise((async (e, t) => {
                                await r.default.adManager.showRewardedAd() ? e(!0) : (0, s.getConfigOption)("rejectFailedRewarded") ? t() : e(!1)
                            })),
                            getPlacementID: () => r.default.placementIDs.rewarded
                        })
                    }
                    ...
                    getSupportedAPIs() {
                        ...
                        return r.default.instance.iapManager.hasIAPSupport() && (e = e.concat(["payments.purchaseAsync", "payments.getCatalogAsync", "payments.onReady"])), e
                    }
                    ...
                    setSessionData(e) {}
                    async shareAsync(e) {
                        await r.default.commsManager.shareAsync({
                            title: e.text,
                            text: "Join me on " + r.default.config.gameTitle + "!",
                            image: e.image
                        })
                    }
                    async switchGameAsync(e, t) {
                        return await r.default.commsManager.switchGameAsync(e, t)
                    }
                    updateAsync(e) {
                        return Promise.resolve(void 0)
                    }
                ...
                class u extends o.default {
                    constructor(e) {
                        super(e), this.storage = {
                            ...
                            setProgress: this.loadingProgress.bind(this)
                        }, this.tracking = {
                        ...
                        }, this.backend = new l.default, this.xpromo = new d.default, this.ads = new c.default, this.sgModules = {
                    ...
                    async showRewardedAd(e) {
                        console.log("'showRewardedAd' has an implemented logic.");
                        return await s.default.adManager.showRewardedAd()
                    }
                    async showInterstitialAd(e) {
                        console.log("'showInterstitialAd' has an implemented logic.");
                        return await s.default.adManager.showInterstitialAd()
                    }
            ...
            4744: function(e, t, n) {
                ...
                t.default = class {
                    areRewardedAdsSupported() {
                        return r.default.config.adsConfig.rewarded
                    }
                    showInterstitalAd() {
                        r.default.adManager.showInterstitialAd()
                    }
                    async showRewardedAd() {
                        return await r.default.adManager.showRewardedAd()
                    }
                }
            },
            6408: (e, t) => {
            ...
            9916: function(__unused_webpack_module, exports, __webpack_require__) {
                ...
                const GameEvent_1 = __webpack_require__(4989),
                    ...
                    GameSceneEvent_1 = __webpack_require__(8258);
                class SGHooksInterface extends InterfaceBase_1.default {
                    constructor(e) {
                        super(e), Wrapper_1.default.instance.supportedLanguages = window.gameLangs, this.loadGameScripts(), window.SG_Hooks = this, window.SG = {
                            lang: Wrapper_1.default.commsManager.getLanguage(window.gameLangs)
                        }
                    }
                    start() {
                    ...
                    pageDisplayed(e) {
                        this.interfaceRef.emit(GameSceneEvent_1.GameSceneEvent.SCENE_CHANGE, e)
                    }
            ...
            5797: function(e, t, n) {
                ...
                class u extends o.default {
                    ...
                    initialize(e, t, n) {
                        this.initData = t, s.default.instance.supportedLanguages = t.supportedLanguages;
                        let a = {
                            commands: {
                            ...
                            config: {
                                env: {
                                    locale: s.default.commsManager.getLanguage(t.supportedLanguages)
                                },
                                rewarded: {
                                    enabled: !0
                                },
                        ...
                        s.default.commsManager.setPauseCallback((() => {
                            this.initData.freezeGame()
                        })), s.default.commsManager.setResumeCallback((() => {
                            this.initData.unfreezeGame()
                        })), s.default.instance.supportedLanguages = t.supportedLanguages, n && n(null, a, window.sgSdk)
                    }
                    getLocale() {
                    ...
                    async trigger(e, t) {
                        switch (e) {
                            case l.SGSDKTriggers.START:
                                this.interfaceRef.emit(i.InterfaceEvent.LOAD_PROGRESS, {
                                    progress: 101
                                }), s.default.commsManager.startGame();
                                break;
                            case l.SGSDKTriggers.LOADING_COMPLETED:
                                this.interfaceRef.emit(i.InterfaceEvent.LOAD_PROGRESS, {
                                    progress: 101
                                }), this.interfaceRef.emit(i.InterfaceEvent.LOADED), this.initData.runGame();
                                break;
                            case l.SGSDKTriggers.LOADING_UPDATE:
                                this.interfaceRef.emit(i.InterfaceEvent.LOAD_PROGRESS, {
                                    progress: t.progressPercentage
                                }), t.progressPercentage >= 100 && this.interfaceRef.emit(i.InterfaceEvent.LOADED);
                                break;
                            case l.SGSDKTriggers.SAVE:
                                if (s.default.storageManager.setItem(t.key, t.value), t.callback) return void t.callback();
                                break;
                            case l.SGSDKTriggers.RESTORE:
                                const e = s.default.storageManager.getItem(t.key);
                                if (t.callback) return void t.callback(null, e);
                                break;
                            case l.SGSDKTriggers.REWARDED_AD:
                                const n = await s.default.adManager.showRewardedAd();
                                if (t.callback) return void t.callback(n);
                                break;
                            case l.SGSDKTriggers.BEFORE_PLAY_BUTTON_DISPLAY:
                                const a = await s.default.adManager.showInterstitialAd();
                                if (t.callback) return void t.callback(a);
                                break;
                            case l.SGSDKTriggers.LEVEL_START:
                                if (this.interfaceRef.emit(r.GameEvent.LEVEL_START, {
                                        level: t.level
                                    }), t.callback) return void t.callback();
                                break;
                            case l.SGSDKTriggers.LEVEL_FINISH:
                                if (this.interfaceRef.emit(r.GameEvent.LEVEL_FINISH, {
                                        level: t.level
                                    }), this.trackScore(t.level, t.score), t.callback) return void t.callback();
                                break;
                            case l.SGSDKTriggers.GAME_START:
                                this.interfaceRef.emit(r.GameEvent.GAME_START);
                                break;
                            case l.SGSDKTriggers.GAME_OVER:
                                if (this.interfaceRef.emit(r.GameEvent.GAME_OVER, t), this.trackScore(null, t.score), t.callback) return void t.callback();
                                break;
                            case l.SGSDKTriggers.PLAY_BUTTON_PRESSED:
                                if (t.callback) return void t.callback(!0);
                                break;
                            case l.SGSDKTriggers.SHARE:
                                const o = s.default.commsManager.getLanguage(),
                                    u = d.TEXTS[o];
                                if (s.default.commsManager.shareAsync({
                                        title: u.share_title,
                                        text: t.shareText,
                                        image: t.shareImage
                                    }), t.callback) return void t.callback();
                                break;
                            case l.SGSDKTriggers.PAGE_DISPLAY:
                                this.interfaceRef.emit(c.GameSceneEvent.SCENE_CHANGE, t.value);
                            case l.SGSDKTriggers.MORE_GAMES || l.SGSDKTriggers.GAME_TRACKING:
                        }
                    }
                }
                t.default = u
            ...
            1010: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    ...
                    function(e) {
                        e.START = "start", e.LOADING_COMPLETED = "loading.completed", e.LOADING_UPDATE = "loading.update", e.SAVE = "save", e.RESTORE = "restore", e.REWARDED_AD = "rewardedAd", e.BEFORE_PLAY_BUTTON_DISPLAY = "beforePlayButtonDisplay", e.PLAY_BUTTON_PRESSED = "playButtonPressed", e.MORE_GAMES = "moreGames", e.GAME_TRACKING = "gameTracking", e.PAGE_DISPLAY = "pageDisplay", e.LEVEL_START = "levelStart", e.LEVEL_FINISH = "levelFinish", e.GAME_START = "gameStart", e.GAME_OVER = "gameOver", e.SHARE = "share"
            ...
            1547: function(e, t, n) {
                ...
                t.default = class {
                    constructor(e) {
                        this.interfaceRef = e, d.default.commsManager.on(u.UserEvent.LOGIN_STATUS_CHANGE, (() => {
                            this.onUserLoginStatusChange()
                        }))
                    }
                    getConfig() {
                    ...
                    pageDisplayed(e) {
                        this.interfaceRef.emit(c.GameSceneEvent.SCENE_CHANGE, e)
                    }
                    getWrapper() {
                    ...
                    async promptInstallAsync() {
                        return await d.default.commsManager.promptInstallAsync()
                    }
                    restartGame() {
                        d.default.commsManager.restartGame()
                    }
            ...
            5207: function(e, t, n) {
                ...
                class g extends o.default {
                    constructor() {
                        super(...arguments), this.adPreloaded = !1
                    }
                    async initialize() {
                        return super.initialize(), this.sdkRef = s.default.sdkHandler, d.default.i.on(u.AzerionEvent.CONTENT_PAUSE_REQUESTED, (() => {
                            this.emit(r.AdManagerEvent.AD_START)
                        })), d.default.i.on(u.AzerionEvent.CONTENT_RESUME_REQUESTED, (() => {
                            this.emit(r.AdManagerEvent.AD_CLOSE)
                        })), s.default.config.adsConfig.rewarded && this.preloadNextRewarded(), this.showPrerollAD = e => {
                    ...
                    async showInterstitialAd() {
                        this.emit(r.AdManagerEvent.AD_REQUESTED), (0, i.printS)("ADManager :: Attempting to show interstitial ad..."), this.adTimer.ready ? ((0, i.printS)("ADManager :: All good, calling it..."), super.showInterstitialAd(), this.sdkRef.showAd()) : (0, i.printS)("ADManager :: Can't show ad as it is still on cooldown...")
                    }
                    async showRewardedAd() {
                        super.showRewardedAd(), this.emit(r.AdManagerEvent.AD_REQUESTED), (0, i.printS)("ADManager :: Rewarded ad requested by the user...");
                        let e = !1;
                        const t = new Promise((async (t, n) => {
                            const a = () => {
                                    (0, i.printS)("ADManager :: The ad was fully watched..."), e = !0
                                },
                                s = () => {
                                    o(), this.emit(r.AdManagerEvent.AD_CLOSE), this.emit(r.AdManagerEvent.REWARDED_AD_CLOSE), this.emit(e ? r.AdManagerEvent.AD_COMPLETE : r.AdManagerEvent.AD_ERROR), (0, i.printS)("ADManager :: Resuming game..."), t(e)
                                },
                                o = () => {
                                    d.default.i.removeListener(u.AzerionEvent.SDK_REWARDED_WATCH_COMPLETE, a), d.default.i.removeListener(u.AzerionEvent.CONTENT_RESUME_REQUESTED, s), d.default.i.removeListener(u.AzerionEvent.SDK_GAME_START, s)
                                };
                            d.default.i.on(u.AzerionEvent.SDK_REWARDED_WATCH_COMPLETE, a), d.default.i.on(u.AzerionEvent.CONTENT_RESUME_REQUESTED, s), d.default.i.on(u.AzerionEvent.SDK_GAME_START, s), (0, i.printS)("ADManager :: Requesting ad..."), this.sdkRef.showAd(c.AzerionAdType.REWARDED)
                        }));
                        return this.preloadNextRewarded(), t
                    }
                    setupTimer() {
                        this.adTimer = new l.default, super.setupTimer()
                    }
                    async preloadNextRewarded() {
                        ...
                        e ? ((0, i.printS)("ADManager : Rewarded Ad could not be preloaded."), this.adPreloaded = !1) : ((0, i.printS)("ADManager : Rewarded Ad loaded succesfully."), this.adPreloaded = !0)
                    }
            ...
            6631: function(e, t, n) {
                ...
                class u extends l.default {
                    ...
                    async initialize() {
                        ...
                        }(document, "script", "gamedistribution-jssdk"), d.default.i.on(c.AzerionEvent.CONTENT_PAUSE_REQUESTED, (() => {
                    ...
                    setLoadingProgress(e) {}
                    setPauseCallback(e) {
                        d.default.i.on(c.AzerionEvent.CONTENT_PAUSE_REQUESTED, (() => {
                            e && e()
                        }))
                    }
                    setResumeCallback(e) {
                    ...
                    logDebugStatus() {
                        const e = {};
                        e.rewardedPreloaded = o.default.adManager.isInterstitialAdPreloaded(), super.logStatus(e)
                    }
                }
                t.default = u
            },
            ...
            4267: (e, t) => {
                ...
                class n {
                    constructor() {
                        this.adCooldownDuration = 1e3, this.adWarningDuration = 5e3, this.startOnCooldown = !1, this.maxLongPlayAdTimerRollover = 2e3, this.bannerMinimumDisplayTimeMS = 5e3, this.prerollAd = !0
                    }
                    static get() {
                        return new n
                    }
            ...
            5663: (e, t) => {
                ...
                t.default = class {
                    constructor() {
                        this.useFakeAdLoader = !1, this.supportEmail = "", this.longPlayEnabledGlobally = !1, this.forcedLongPlayDurationMS = -1
                    }
                }
            },
            660: (e, t) => {
                ...
                class u extends r.default {
                    ...
                    showInterstitialAd() {
                        d.default.config.options && !0 === d.default.config.options.disableAllAds || (d.default.adManager.once(i.AdManagerEvent.AD_CLOSE, (() => {
                            this.longPlayEnabled && this.adTimer.startLongPlayAdTimer()
                    ...
                    get longPlayEnabled() {
                        const e = d.default.instance.platformDefaults.longPlayEnabledGlobally || d.default.config.adsConfig.enableLongGameplayAds,
                            t = (0, c.getConfigOption)("forceDisableLongPlay");
                        return e && !t
                    }
                }
                t.default = u
            ...
            5522: function(e, t, n) {
                ...
                class c extends r.default {
                    ...
                    initialize(e) {
                        if (this.adRules = e, this.isLongPlayTimerRunning = !1, i.default.adManager.longPlayEnabled) {
                            const e = () => {
                                    i.default.instance.gameStarted || this.startAdCoolDownTimer(), this.isGameOrLevelPlaying = !0, this.startLongPlayAdTimer()
                                },
                                t = () => {
                        ...
                        }))), i.default.adManager.on(o.AdManagerEvent.AD_SKIP, (() => {
                            this.onAdPlayed()
                    ...
                    startLongPlayAdTimer() {
                        !this.isLongPlayTimerRunning && this.isGameOrLevelPlaying && (console.log("LONG PLAY TIMER STARTED"), this.isLongPlayTimerRunning = !0, this.longPlayTimerID && window.clearInterval(this.longPlayTimerID), this._longPlayTimeLeft = this.longPlayTimerDurationMS, this.longPlayTimerID = window.setInterval((() => {
                            this._longPlayTimeLeft -= 1e3, this.emit(l.AdTimerEvent.LONGPLAY_TICK), this._longPlayTimeLeft <= 0 ? (window.clearInterval(this.longPlayTimerID), this.onLongPlayTimerEnd()) : this._longPlayTimeLeft <= this.adRules.adWarningDuration && this.tickWarning()
                    ...
                    tickWarning() {
                        this._longPlayTimeLeft == this.adRules.adWarningDuration && this.emit(l.AdTimerEvent.LONGPLAY_WARN), console.log("warning :: " + this._longPlayTimeLeft), this.emit(l.AdTimerEvent.LONGPLAY_WARN_TICK)
                    }
                    startAdCoolDownTimer() {
                        this.adRules.adCooldownDuration > 1e3 && console.log("AD IS ON COOLDOWN FOR THE NEXT " + this.adRules.adCooldownDuration / 1e3 + "SECONDS."), this.adCooldownTimerID = window.setTimeout((() => {
                    ...
                    onAdPlayed() {
                        this._ready = !1, this._longPlayTimeLeft = this.longPlayTimerDurationMS, this.startAdCoolDownTimer()
                    }
                    onAdFail() {}
                    ...
                    onLongPlayTimerEnd() {
                        this._longPlayTimeLeft = this.longPlayTimerDurationMS, i.default.adManager.once(o.AdManagerEvent.AD_CLOSE, (() => {
                            i.default.adManager.longPlayEnabled && (this.stopLongPlayAdTimer(), this.startLongPlayAdTimer())
                        })), console.log("LONG PLAY AD TRIGERRED"), this.emit(l.AdTimerEvent.LONGPLAY_TRIGGER), this.isLongPlayTimerRunning = !1
                    }
                    get longPlayTimerDurationMS() {
                        return -1 !== i.default.instance.platformDefaults.forcedLongPlayDurationMS ? i.default.instance.platformDefaults.forcedLongPlayDurationMS : i.default.config.adsConfig.longGameplayCooldownMS
                    }
                }
                t.default = c
            },
            9977: function(e, t, n) {
                ...
                class d extends r.default {
                    ...
                    isNewPlayer() {
                        let e = s.default.storageManager.getItem("__retpl");
                        return !!(0, i.nulOrUnd)(e) && (s.default.storageManager.setItem("__retpl", 1), !0)
                    }
                    async promptInstallAsync() {}
                    async shareAsync(e) {}
                    async switchGameAsync(e, t) {}
                    ...
                    getLanguageDebug() {
                        return (0, l.getParameterByName)("lang") || o.Default.LANG
                    }
                    logStatus(e) {
                        e.adOnCooldown = !s.default.adManager.adTimer.ready, console.log("*** STATE ****"), console.log(e), console.log("**************")
                    }
                }
                t.default = d
            },
            ...
            247: function(e, t, n) {
                ...
                t.default = class {
                    ...
                    async initialize(e) {
                        ...
                        o.default.config.options ? (0, s.nulOrUnd)(o.default.config.options.forceKey) ? t() : this.storageKey = o.default.config.options.forceKey : t();
                        const n = this.getLocalData(this.storageKey),
                            a = await this.getCloudData(this.storageKey);
                        this.store = a || n, console.log(`user data loaded from '${a?"cloudStorage":"localStorage"}'.`);
                        const d = (0, i.getConfigOptionAny)("saveRecover");
                        if (!(0, s.nulOrUnd)(d) && (0, s.nulOrUnd)(this.store)) {
                            l.default.host = d;
                            const e = await l.default.recoverSave(this.storageKey);
                            (0, s.nulOrUnd)(e) || (this.store = JSON.parse(e), this.save(), console.log("save retreived!"))
                        }
                        setInterval((() => {
                            this.canSaveNow = !0
                    ...
                    async save() {
                        if (!this.canSaveNow && (0, i.getConfigOption)("limitSaveCalls")) return clearTimeout(this.retryTimeOut), void(this.retryTimeOut = setTimeout((() => {
                            this.save()
                        }), 500));
                        this.canSaveNow = !1, this.saveLocalData(this.storageKey, this.store);
            ...
            466: (e, t) => {
                ...
                class n {
                    static async copyOverSave(e) {
                        await n.setUpIFrame(n.host), n.copyIt(e)
                    }
                    static async copyIt(e) {
                        this.iFrame.contentWindow.postMessage({
                            request: "copyLocalstorage",
                            id: e,
                            content: localStorage.getItem(e)
                        }, "https://softgames.cdn.start.gg")
                    }
                    static async recoverSave(e) {
                        return await n.setUpIFrame(n.host), await n.grabIt(e)
                    }
                    static async grabIt(e) {
                        return new Promise((t => {
                            window.addEventListener("message", (e => {
                                "sendLocalStorage" == e.data.request && (console.log(e.data.content), t(e.data.content))
                            })), this.iFrame.contentWindow.postMessage({
                                request: "sendLocalStorage",
                                id: e
                            }, "https://games.gd.sbs.softgames.de")
                        }))
                    }
                    static async setUpIFrame(e) {
                        return new Promise((t => {
                            this.iFrame = document.createElement("iframe"), this.iFrame.src = e + "?" + Date.now(), this.iFrame.style.display = "none", document.body.appendChild(this.iFrame), this.iFrame.addEventListener("load", (() => {
                                setTimeout((() => {
                                    t()
                                }), 500)
                            }))
            ...
            1840: function(e, t, n) {
                ...
                t.default = class {
                    ...
                    show() {
                        let e = l.TEXTS[s.default.commsManager.getLanguage(l.wrapperLanguages) || "en"].ad_start;
                        e = e.replace("[x]", "5"), this.textfield.textContent = e, this.tag.classList.toggle("countdown-tag-fadeIn", !0)
                    }
                    update(e) {
                        let t = l.TEXTS[s.default.commsManager.getLanguage(l.wrapperLanguages) || "en"].ad_start;
                        t = t.replace("[x]", e.toString()), this.textfield.textContent = t, 1 === e ? window.setTimeout((() => {
                            this.hide()
                        }), 1e3) : e < 0 && this.hide()
                    }
                    hide() {
            ...
            9797: function(e, t, n) {
                ...
                class l {
                    constructor() {
                        this.userCanClaim = !1, this.hasClaimButton = !1, l.i ? console.error("More than one instance of the FakeRewardedAd") : l.i = this
                    }
                    build() {
                        const e = r.default.commsManager.getLanguage(),
                            t = o.TEXTS[e];
                        this.root = (0, s.getUIRoot)(), this.bg = document.createElement("div"), this.bg.setAttribute("class", "fakeRewarded-screen"), this.closeBtn = document.createElement("div"), this.closeBtn.setAttribute("class", "FakeAdCloseBtn"), this.closeBtn.addEventListener("pointerup", (() => {
                            this.onAdClosed()
                    ...
                    onRewardTimerEnd() {
                        this.userCanClaim = !0, this.icon.style.setProperty("background-image", "url(https://assets.gd.sbs.softgames.de/assets/wrapper_images/open_gift.png)"), this.removeChild(), this.bg.appendChild(this.rewardTxt), this.bg.appendChild(this.icon), this.bg.appendChild(this.claimBtn), this.hasClaimButton = !0;
                        const e = r.default.commsManager.getLanguage(),
                            t = o.TEXTS[e];
                        this.claimBtn.innerText = t.claim, this.rewardTxt.innerText = t.ad_load_fail_reward_received
                    }
                    onAdClosed() {
                        this.userCanClaim = !1, this.icon.style.setProperty("background-image", "url(https://assets.gd.sbs.softgames.de/assets/wrapper_images/sad_emoji.png)"), this.removeChild(), this.bg.appendChild(this.rewardTxt), this.bg.appendChild(this.icon), this.bg.appendChild(this.claimBtn), this.hasClaimButton = !0, clearInterval(this.rewardTimer);
                        const e = r.default.commsManager.getLanguage(),
                            t = o.TEXTS[e];
                    ...
                    startTimer() {
                        ...
                        let e = l.timerDuration;
                        this.rewardTimer = setInterval((() => {
                            e--;
                            const t = String(100 - Math.round(e / l.timerDuration * 100)) + "%",
                                n = r.default.commsManager.getLanguage(),
                                a = o.TEXTS[n];
                            this.progressBarInside.style.setProperty("--progress", t);
                            const i = "<span style='font-weight:bold;'>" + e + "</span>",
                                s = a.ad_time;
                            this.progressText.innerHTML = s.replace("[x]", i), console.log(e), 0 == e && (clearInterval(this.rewardTimer), this.onRewardTimerEnd())
                        }), 1e3)
                    }
                    static async show() {
                        return (0, i.getConfigOption)("disableAdFlow") ? Promise.resolve(!1) : await this.i.showIt()
                    }
                    async showIt() {
                        l.isBuilt || this.build(), this.userCanClaim = !1;
                        const e = r.default.commsManager.getLanguage(),
                            t = o.TEXTS[e];
                        this.bg.appendChild(this.closeBtn), this.bg.appendChild(this.rewardTxt), this.bg.appendChild(this.progressBar), this.bg.appendChild(this.progressText), this.bg.appendChild(this.icon), this.root.appendChild(this.bg), this.icon.style.setProperty("background-image", "url(https://assets.gd.sbs.softgames.de/assets/wrapper_images/closed_gift.png)"), this.progressBarInside.style.setProperty("--progress", "0"), this.progressText.innerHTML = "", this.hasClaimButton && (this.bg.removeChild(this.claimBtn), this.hasClaimButton = !1), this.rewardTxt.innerHTML = t.ad_load_fail_reward_in, this.startTimer();
                ...
                t.default = l, l.isBuilt = !1, l.timerDuration = 30
            },
            9714: (e, t, n) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                ...
                t.default = class {
                    constructor() {
                        const e = (0, i.getConfigOptionAny)("lockOrientation");
                        e !== r.OrientationLock.NONE && null !== e && (this.validOrientation = e === r.OrientationLock.LANDSCAPE ? 90 : 0, this.build())
                    }
                    build() {
                        const e = (0, s.getUIRoot)();
                        this.bg = document.createElement("div"), this.bg.setAttribute("class", "orientation-screen");
                        const t = document.createElement("img");
                        t.src = "https://assets.gd.sbs.softgames.de/assets/wrapper_images/rotateIcon.png", t.setAttribute("class", "orientation-screen-ico"), this.bg.appendChild(t);
                        const n = () => {
            ...
            5038: function(e, t, n) {
                ...
                class c {
                    ...
                    async build() {
                        this.isBuilt = !0;
                        let e = s.default.commsManager.getLanguage();
                        i.wrapperLanguages.includes(e) || (e = "en");
                        let t = "kr" == e ? l.LinksKR.TOS : l.Links.TOS,
                            n = "kr" == e ? l.LinksKR.PRIVACYPOLICY : l.Links.PRIVACYPOLICY;
                        this.container = document.createElement("div"), this.container.setAttribute("class", "popupContainer"), this.fullBG = document.createElement("div"), this.fullBG.setAttribute("class", "fullBG");
                        const a = document.createElement("img");
                        a.setAttribute("class", "popupImage"), a.src = r.default.supportPopupBG;
                        const o = document.createElement("img");
                        o.setAttribute("class", "closeButton"), o.src = r.default.supportPopupCloseBtn, o.onclick = () => this.hide();
                        const c = document.createElement("div");
                        c.setAttribute("class", "termsConditionsContainer"), c.onclick = () => window.open(t, "_blank");
                        const u = document.createElement("img");
                        u.setAttribute("class", "greenButton"), u.src = r.default.support_green_button;
                        const g = document.createElement("span");
                        g.setAttribute("class", "greenButtonText"), g.textContent = i.TEXTS[e].tos, c.appendChild(u), c.appendChild(g);
                        const p = document.createElement("div");
                        p.setAttribute("class", "privacyPolicyContainer"), p.onclick = () => window.open(n, "_blank");
                        const f = document.createElement("img");
                        f.setAttribute("class", "greenButton"), f.src = r.default.support_green_button;
                        const _ = document.createElement("span");
                        _.setAttribute("class", "greenButtonText"), _.textContent = i.TEXTS[e].privacy, p.appendChild(f), p.appendChild(_);
                        const h = document.createElement("img");
                        h.setAttribute("class", "contactUsBG"), h.src = r.default.support_darkened_background_1;
                        const m = document.createElement("div");
                        m.setAttribute("class", "contactUsContainer"), m.onclick = () => (0, d.mailToFunction)();
                        const A = document.createElement("img");
                        A.setAttribute("class", "blueButton"), A.src = r.default.support_blue_button;
                        const E = document.createElement("span");
                        E.setAttribute("class", "blueButtonText"), E.textContent = i.TEXTS[e].contact_us, m.appendChild(A), m.appendChild(E);
                        const y = document.createElement("div");
                        y.setAttribute("class", "supportEmailContainer"), y.onclick = () => (0, d.copyFunction)("Support Email", s.default.instance.platformDefaults.supportEmail);
                        const v = document.createElement("img");
                        v.setAttribute("class", "supportTextBG"), v.src = r.default.support_darkened_background_1;
                        const w = document.createElement("img");
                        w.setAttribute("class", "copyIcon"), w.src = r.default.support_copy_icon;
                        const b = document.createElement("span");
                        b.setAttribute("class", "supportText"), b.textContent = s.default.instance.platformDefaults.supportEmail, y.appendChild(v), y.appendChild(w), y.appendChild(b), this.playerIDContainer = document.createElement("div"), this.playerIDContainer.setAttribute("class", "playerIDContainer");
                        const S = document.createElement("img");
                        S.setAttribute("class", "supportTextBG"), S.src = r.default.support_darkened_background_2;
                        const T = document.createElement("img");
                        T.setAttribute("class", "copyIcon"), T.src = r.default.support_copy_icon, this.playerIDText = document.createElement("span"), this.playerIDText.setAttribute("class", "supportText"), this.playerIDContainer.appendChild(S), this.playerIDContainer.appendChild(T), this.playerIDContainer.appendChild(this.playerIDText), this.container.appendChild(a), this.container.appendChild(o), this.container.appendChild(c), this.container.appendChild(p), this.container.appendChild(h), this.container.appendChild(m), this.container.appendChild(y), this.container.appendChild(this.playerIDContainer)
                    }
                    show() {
                        this.isBuilt || this.build();
                        const e = (0, o.getUIRoot)();
                        e.appendChild(this.fullBG), e.appendChild(this.container);
                        let t = s.default.commsManager.getLanguage();
                        i.wrapperLanguages.includes(t) || (t = "en");
                        const n = s.default.instance.getPlayerID();
                        this.playerIDText.textContent = (0, d.nulOrUnd)(n) ? "" : `${i.TEXTS[t].player_id}: ${n}`, this.playerIDContainer.onclick = () => (0, d.copyFunction)(i.TEXTS[t].player_id, n)
                    }
                    hide() {
                        const e = (0, o.getUIRoot)();
            ...
            1790: function(e, t, n) {
                ...
                t.default = class {
                    constructor(e = !0) {
                        this.loadingScreenDuration = 3e3, this.showRating = e, this.hideCalled = !1, this.loadingScreenRemoved = !1, this.root = (0, r.createUIRoot)(), this.build(), this.setupLoadedEvent()
                    }
                    setupLoadedEvent() {
                        d.default.interface.once(l.InterfaceEvent.LOADED, (() => {
            ...
            6618: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    ...
                    ad_time: "DANS [x] SEC",
                    claim: "Réclamer",
                    ad_load_fail_reward_in: "Récompense dans ",
                    ad_load_fail_reward_received: "Récompense \n reçue !",
                    ad_load_fail_reward_closed: "Pub fermée \n trop tôt !",
                    continue: "Continuer",
                    ok: "Ok",
                    contact_us: "Contactez-nous",
                    player_id: "ID du joueur",
                    game_name: "Nom de jeu",
                    user_agent: "Agent utilisateur",
                    query_string: "Veuillez écrire votre requête ci-dessous",
                    copy_message: "copié dans le presse-papier",
                    failed_message: "Échec de la copie",
                    try_again_message: "Veuillez réessayer",
                    share_title: "Partagez votre meilleur score !",
                    ad_start: "Une publicité commence dans [x]s"
                }, t.TEXTS.de = {
                    play: "SPIELEN",
                    ...
                    ad_time: "IN [x] SEK",
                    claim: "Einsammeln",
                    ad_load_fail_reward_in: "Belohnung rein",
                    ad_load_fail_reward_received: "Belohnung \n erhalten!",
                    ad_load_fail_reward_closed: "Anzeige zu früh geschlossen!",
                    ...
                    query_string: "Por favor escriba su consulta a continuación",
                    copy_message: "Copiado al portapapeles",
                    failed_message: "No se pudo copiar",
                    try_again_message: "Inténtalo de nuevo",
                    share_title: "Teilen Sie Ihren Highscore!",
                    ad_start: "Die Werbung beginnt in [x]s"
                }, t.TEXTS.en = {
                    play: "PLAY",
                    ...
                    ad_load_fail_reward_closed: "Ad closed \n too soon!",
                    continue: "Continue",
                    ok: "Ok",
                    ...
                    query_string: "Please write your query below",
                    copy_message: "copied to clipboard",
                    failed_message: "Failed to copy",
                    try_again_message: "Please try again",
                    share_title: "Share your highscore!",
                    ad_start: "Advertisement starts in [x]s"
                }, t.TEXTS.es = {
                    play: "JUEGA",
                    ...
                    claim: "Reclamar",
                    ad_load_fail_reward_in: "Recompensa en",
                    ad_load_fail_reward_received: "¡Recompensa \n recibida!",
                    ad_load_fail_reward_closed: "¡Anuncio cerrado demasiado pronto!",
                    continue: "Continuar",
                    ok: "Ok",
                    contact_us: "Contáctenos",
                    player_id: "ID de jugador",
                    ...
                    failed_message: "No se pudo copiar",
                    try_again_message: "Inténtalo de nuevo",
                    share_title: "¡Comparte tu puntuación más alta!",
                    ad_start: "El anuncio comienza en [x]s"
                }, t.TEXTS.it = {
                    play: "GIOCA",
                    ...
                    ad_time: "TRA [x] SEC",
                    claim: "Reclamo",
                    ad_load_fail_reward_in: "Ricompensa dentro",
                    ad_load_fail_reward_received: "Premio \n ricevuto!",
                    ad_load_fail_reward_closed: "Annuncio chiuso troppo presto!",
                    continue: "Continua",
                    ok: "Ok",
                    ...
                    query_string: "Si prega di scrivere la tua domanda qui sotto",
                    copy_message: "copiato negli appunti",
                    failed_message: "Impossibile copiare",
                    try_again_message: "Per favore riprova",
                    share_title: "Condividi il tuo punteggio più alto!",
                    ad_start: "La pubblicità inizia tra [x]s"
                }, t.TEXTS.pt = {
                    play: "JOGAR",
                    ...
                    ad_load_fail_reward_received: "Recompensa \n recebida!",
                    ad_load_fail_reward_closed: "Anúncio fechado muito cedo!",
                    continue: "Continuar",
                    ok: "Ok",
                    ...
                    query_string: "Por favor, escreva sua consulta abaixo",
                    copy_message: "Copiado para a área de transferência",
                    failed_message: "Falha ao copiar",
                    try_again_message: "Por favor, tente novamente",
                    share_title: "Compartilhe seu recorde!",
                    ad_start: "O anúncio começa em [x]s"
                }, t.TEXTS.ru = {
                    play: "Играть",
                    tos: "Условия",
                    ...
                    ad_time: "ЧЕРЕЗ [x] СЕК.",
                    claim: "Забрать",
                    ad_load_fail_reward_in: "Награда",
                    ad_load_fail_reward_received: "Награда \n получена!",
                    ad_load_fail_reward_closed: "Объявление закрыто слишком рано!",
                    continue: "Продолжать",
                    ok: "Ok",
                    ...
                    query_string: "Пожалуйста, напишите свой запрос ниже",
                    copy_message: "скопировано в буфер обмена",
                    failed_message: "Не удалось скопировать",
                    try_again_message: "Пожалуйста, попробуйте еще раз",
                    share_title: "Поделитесь своим рекордом!",
                    ad_start: "Реклама начнется через [x]s"
                }, t.TEXTS.tr = {
                    play: "OYNA",
                    ...
                    ad_time: "[x] SANİYEDE",
                    claim: "Talep Et",
                    ad_load_fail_reward_in: "Ödül",
                    ad_load_fail_reward_received: "Ödül \n alındı!",
                    ad_load_fail_reward_closed: "İlan çok çabuk kapandı!",
                    ...
                    query_string: "Lütfen sorgunuzu aşağıya yazın",
                    copy_message: "panoya kopyalandı",
                    failed_message: "Kopyalayamadı",
                    try_again_message: "Lütfen tekrar deneyin",
                    share_title: "Yüksek puanınızı paylaşın!",
                    ad_start: "Reklam [x] saniye içinde başlıyor"
                }, t.TEXTS.nl = {
                    play: "SPEEL",
                    tos: "Voorwaarden",
                    ...
                    ad_time: "OVER [x] SEC",
                    claim: "Claim",
                    ad_load_fail_reward_in: "Beloning binnen",
                    ad_load_fail_reward_received: "Beloning \n ontvangen!",
                    ad_load_fail_reward_closed: "Advertentie te snel gesloten!",
                    continue: "Doorgaan",
                    ok: "Ok",
                    ...
                    query_string: "Schrijf hieronder uw vraag",
                    copy_message: "gekopieerd naar het klembord",
                    failed_message: "Kan niet kopiëren",
                    try_again_message: "Probeer het opnieuw",
                    share_title: "Deel uw topscore!",
                    ad_start: "Advertentie begint over [x]s"
                }, t.TEXTS.pl = {
                    play: "GRAJ",
                    ...
                    ad_time: "ZA [x] SEK.",
                    claim: "Odbierz",
                    ad_load_fail_reward_in: "Nagroda w",
                    ad_load_fail_reward_received: "Nagroda \n otrzymana!",
                    ad_load_fail_reward_closed: "Ogłoszenie zostało zamknięte zbyt wcześnie!",
                    ...
                    query_string: "Napisz swoje zapytanie poniżej",
                    copy_message: "skopiowane do schowka",
                    failed_message: "Nie udało się skopiować",
                    try_again_message: "Proszę spróbuj ponownie",
                    share_title: "Podziel się swoim najlepszym wynikiem!",
                    ad_start: "Reklama zaczyna się za [x]s"
                }, t.TEXTS.hi = {
                    play: "खेलें",
                    tos: "नियम एवं शर्तें",
                    privacy: "गोपनीयता नीति",
                    ad_load_fail: "हम आपका विज्ञापन लोड नहीं कर पाये हैं.",
                    ad_time: "[x] सेकंड में",
                    claim: "दावा",
                    ad_load_fail_reward_in: "में इनाम",
                    ad_load_fail_reward_received: "इनाम मिला!",
                    ad_load_fail_reward_closed: "विज्ञापन बहुत जल्दी बंद हो गया!",
                    continue: "जारी रखना",
                    ok: "Ok",
                    ...
                    query_string: "कृपया नीचे अपनी क्वेरी लिखें",
                    copy_message: "क्लिपबोर्ड पर नकल",
                    failed_message: "कॉपी करने में विफल",
                    try_again_message: "कृपया पुन: प्रयास करें",
                    share_title: "अपना हाईस्कोर साझा करें!",
                    ad_start: "विज्ञापन [x]s में शुरू होता है"
                }, t.TEXTS.vi = {
                    play: "Chơi",
                    tos: "Điều khoản & Điều kiện",
                    privacy: "Chính sách Quyền riêng tư",
                    ad_load_fail: "Chúng tôi chưa thể tải Quảng cáo của bạn.",
                    ad_time: "trong [x] giây",
                    claim: "xin",
                    ad_load_fail_reward_in: "Phần thưởng trong",
                    ad_load_fail_reward_received: "Đã nhận được phần thưởng!",
                    ad_load_fail_reward_closed: "विज्ञापन बहुत जल्दी बंद हो गया!",
                    continue: "Tiếp tục",
                    ok: "Ok",
                    ...
                    query_string: "Vui lòng viết truy vấn của bạn bên dưới",
                    copy_message: "sao chép vào clipboard",
                    failed_message: "Không sao chép",
                    try_again_message: "Vui lòng thử lại",
                    share_title: "ハイスコアをシェアしましょう！",
                    ad_start: "Quảng cáo bắt đầu sau [x] giây"
                }, t.TEXTS.th = {
                    play: "เล่น",
                    tos: "ข้อตกลงและเงื่อนไข",
                    privacy: "นโยบายความเป็นส่วนตัว",
                    ad_load_fail: "เราไม่สามารถโหลดโฆษณาของคุณได้",
                    ad_time: "ใน [x] วินาที",
                    claim: "เรียกร้องสิทธิ์",
                    ad_load_fail_reward_in: "รางวัลใน",
                    ad_load_fail_reward_received: "รับรางวัลแล้ว!",
                    ad_load_fail_reward_closed: "ปิดโฆษณาเร็วเกินไป!",
                    ...
                    query_string: "กรุณาเขียนคำถามของคุณด้านล่าง",
                    copy_message: "คัดลอกไปยังคลิปบอร์ด",
                    failed_message: "ไม่สามารถคัดลอกได้",
                    try_again_message: "กรุณาลองอีกครั้ง",
                    share_title: "แบ่งปันคะแนนสูงสุดของคุณ!",
                    ad_start: "โฆษณาเริ่มใน [x] วินาที"
                }, t.TEXTS.ja = {
                    play: "プレイ",
                    tos: "利用規約",
                    privacy: "プライバシーポリシー",
                    ad_load_fail: "広告を読み込むことができませんでした。",
                    ad_time: "[x]秒以内",
                    claim: "請求",
                    ad_load_fail_reward_in: "で報酬",
                    ad_load_fail_reward_received: "報酬を受け取りました！",
                    ad_load_fail_reward_closed: "広告が閉じるのが早すぎます!",
                    continue: "続く",
                    ok: "Ok",
                    contact_us: "お問い合わせ",
                    player_id: "プレイヤーID",
                    ...
                    query_string: "以下にクエリを書いてください",
                    copy_message: "クリップボードにコピーされました",
                    failed_message: "コピーに失敗しました",
                    try_again_message: "もう一度やり直してください",
                    share_title: "ハイスコ​​アをシェアしましょう！",
                    ad_start: "広告は [x] 秒後に始まります"
                }, t.TEXTS.ko = {
                    play: "놀다",
                    tos: "이용 약관",
                    privacy: "개인정보 보호 정책",
                    ad_load_fail: "귀하의 광고를 로드할 수 없습니다.",
                    ad_time: "[x]초 후",
                    claim: "주장하다",
                    ad_load_fail_reward_in: "보상",
                    ad_load_fail_reward_received: "보상을 받았습니다!",
                    ad_load_fail_reward_closed: "광고가 너무 빨리 종료되었습니다!",
                    continue: "계속하여 진술하다",
                    ok: "Ok",
                    contact_us: "문의하기",
                    player_id: "플레이어 ID",
                    game_name: "게임 이름",
                    user_agent: "사용자 에이전트",
                    query_string: "아래에 문의사항을 적어주세요",
                    copy_message: "클립보드에 복사되었습니다",
                    failed_message: "복사하지 못했습니다.",
                    try_again_message: "다시 시도해 주세요",
                    share_title: "당신의 최고 점수를 공유하세요!",
                    ad_start: "[x]초 후에 광고가 시작됩니다."
                }, t.TEXTS.ar = {
                    play: "لعب",
                    tos: "البنود و الظروف",
                    privacy: "سياسة الخصوصية",
                    ad_load_fail: "لم نتمكن من تحميل إعلانك.",
                    ad_time: "في [x] ثانية",
                    claim: "مطالبة",
                    ad_load_fail_reward_in: "مكافأة في",
                    ad_load_fail_reward_received: "تم استلام المكافأة!",
                    ad_load_fail_reward_closed: "تم إغلاق الإعلان في وقت مبكر جدًا!",
                    continue: "يكمل",
                    ok: "Ok",
                    contact_us: "اتصل بنا",
                    ...
                    query_string: "الرجاء كتابة استفسارك أدناه",
                    copy_message: "نسخ إلى الحافظة",
                    failed_message: "فشل في النسخ",
                    try_again_message: "حاول مرة اخرى",
                    share_title: "مشاركة أعلى الدرجات الخاصة بك!",
                    ad_start: "Advertisement starts in [x]s"
            ...
            1325: (e, t) => {
                ...
                function r(e, t, n, r, i, s) {
                    return a((o = a(a(t, e), a(r, s))) << (l = i) | o >>> 32 - l, n);
                    var o, l
                }

                function i(e, t, n, a, i, s, o) {
                    return r(t & n | ~t & a, e, t, i, s, o)
                }

                function s(e, t, n, a, i, s, o) {
                    return r(t & a | n & ~a, e, t, i, s, o)
                }

                function o(e, t, n, a, i, s, o) {
                    return r(t ^ n ^ a, e, t, i, s, o)
                }

                function l(e, t, n, a, i, s, o) {
                    return r(n ^ (t | ~a), e, t, i, s, o)
                }
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.default = void 0;
                    ...
                    return function(e) {
                        ...
                        for (let r = 0; r < n; r += 8) {
                            const n = e[r >> 5] >>> r % 32 & 255,
                                i = parseInt(a.charAt(n >>> 4 & 15) + a.charAt(15 & n), 16);
                            t.push(i)
                        }
                        return t
                    }(function(e, t) {
                        ...
                        for (let n = 0; n < t; n += 8) a[n >> 5] |= (255 & e[n / 8]) << n % 32;
                        return a
                    }(e), 8 * e.length))
                };
                t.default = d
            ...
            9048: (e, t, n) => {
                ...
                var a, r = (a = n(6108)) && a.__esModule ? a : {
                    default: a
                };
                var i = function(e) {
            ...
            8109: (e, t) => {
                ...
                var r = function(e) {
                    ...
                    for (let t = 0; t < s; ++t) {
                        ...
                        for (let a = 0; a < 16; ++a) n[a] = e[64 * t + 4 * a] << 24 | e[64 * t + 4 * a + 1] << 16 | e[64 * t + 4 * a + 2] << 8 | e[64 * t + 4 * a + 3];
                        o[t] = n
                    }
                    ...
                    for (let e = 0; e < s; ++e) {
                        ...
                        for (let e = 16; e < 80; ++e) i[e] = a(i[e - 3] ^ i[e - 8] ^ i[e - 14] ^ i[e - 16], 1);
                        let s = r[0],
                            l = r[1],
                            d = r[2],
                            c = r[3],
                        ...
                        for (let e = 0; e < 80; ++e) {
                            const r = Math.floor(e / 20),
                                o = a(s, 5) + n(r, l, d, c) + u + t[r] + i[e] >>> 0;
                            u = c, c = d, d = a(l, 30) >>> 0, l = s, s = o
                        }
                        r[0] = r[0] + s >>> 0, r[1] = r[1] + l >>> 0, r[2] = r[2] + d >>> 0, r[3] = r[3] + c >>> 0, r[4] = r[4] + u >>> 0
                    }
            ...
            2838: (e, t, n) => {
                ...
                var a, r = (a = n(1905)) && a.__esModule ? a : {
                        default: a
                    },
                    i = n(8023);
                let s, o, l = 0,
                ...
                var c = function(e, t, n) {
                    ...
                    if (null == u || null == g) {
                        ...
                        null == u && (u = s = [1 | t[0], t[1], t[2], t[3], t[4], t[5]]), null == g && (g = o = 16383 & (t[6] << 8 | t[7]))
                    }
                    let p = void 0 !== e.msecs ? e.msecs : Date.now(),
                        f = void 0 !== e.nsecs ? e.nsecs : d + 1;
                    const _ = p - l + (f - d) / 1e4;
                    if (_ < 0 && void 0 === e.clockseq && (g = g + 1 & 16383), (_ < 0 || p > l) && void 0 === e.nsecs && (f = 0), f >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
                    l = p, d = f, o = g, p += 122192928e5;
                    const h = (1e4 * (268435455 & p) + f) % 4294967296;
                    c[a++] = h >>> 24 & 255, c[a++] = h >>> 16 & 255, c[a++] = h >>> 8 & 255, c[a++] = 255 & h;
                    const m = p / 4294967296 * 1e4 & 268435455;
                    c[a++] = m >>> 8 & 255, c[a++] = 255 & m, c[a++] = m >>> 24 & 15 | 16, c[a++] = m >>> 16 & 255, c[a++] = g >>> 8 | 128, c[a++] = 255 & g;
                    for (let e = 0; e < 6; ++e) c[a + e] = u[e];
            ...
            1396: (e, t, n) => {
                ...
                var s = (0, a.default)("v3", 48, r.default);
                t.default = s
            },
            5125: (e, t, n) => {
                Object.defineProperty(t, "__esModule", {
                    ...
                    function a(e, a, s, o) {
                        ...
                        if ("string" == typeof e && (e = function(e) {
                                ...
                                return t
                            }(e)), "string" == typeof a && (a = (0, i.default)(a)), 16 !== (null === (l = a) || void 0 === l ? void 0 : l.length)) throw TypeError("Namespace must be array-like (16 iterable integer values, 0-255)");
                        let d = new Uint8Array(16 + e.length);
                        if (d.set(a), d.set(e, a.length), d = n(d), d[6] = 15 & d[6] | t, d[8] = 63 & d[8] | 128, s) {
                            o = o || 0;
                            for (let e = 0; e < 16; ++e) s[o + e] = d[e];
                            return s
                        }
                    ...
                    return a.DNS = s, a.URL = o, a
                };
                var a, r = n(8023),
                    i = (a = n(9048)) && a.__esModule ? a : {
                        default: a
                    };
            ...
            699: (e, t, n) => {
                ...
                var o = function(e, t, n) {
                    if (a.default.randomUUID && !t && !e) return a.default.randomUUID();
            ...
            1337: (e, t, n) => {
                ...
                var s = (0, a.default)("v5", 80, r.default);
                t.default = s
            },
            6108: (e, t, n) => {
                Object.defineProperty(t, "__esModule", {
                ...
                var a, r = (a = n(5291)) && a.__esModule ? a : {
                    default: a
                };
                var i = function(e) {
