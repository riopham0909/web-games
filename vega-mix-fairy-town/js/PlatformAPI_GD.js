        ...
        /*ysdk.adv.showFullscreenAdv({
          callbacks: {
            onClose: function(wasShown) {
              NetworkPlatformApi.uiCallback.call(null, closeUid, onCloseMethodName, {"state" : "close", "wasShown" : wasShown});
            },
            onError: function(error) {
              NetworkPlatformApi.uiCallback.call(null, errorUid, onErrorMethodName, {"state" : "error", "error" : error});
            },
            onOpen: function() {
              NetworkPlatformApi.uiCallback.call(null, openUid, onOpenMethodName, {"state" : "open"});
            }
          }
        }); */
      },
