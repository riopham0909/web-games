var _azerionBuildVersion = "tc-2";
var _azerionIntegration = {
    "gdId": "2d20a57604ba4fde8f83a7e072e83ea6",
    "rtgEnabled": false,
    "lbEnabled": false,
    "fbType": "dummy",
    "alxType": "none",
    ...
    "build": {
        "version": "tc-2",
        "timeStamp": 1695305101099,
        "h": "9cdedd7f"
    },
    "gameTitle": "Bubble Shooter Free"
};
var playBtn = true;
var fbrqBD = 8;
var fbrqLA = true;
...
function(t, e) {
    ...
    t(function(t, I) {
        ...
        function f(t, e) {
            t._state === k && (t._result = e, t._state = B, 0 !== t._subscribers.length) && _(s, t)
        }

        function m(t, e) {
            t._state === k && (t._state = L, t._result = e, _(j, t))
        }
        ...
        function g(t, e, n, i) {
            ...
            e._state === k && (r && s ? p(e, o) : !1 === s ? m(e, a) : t === B ? f(e, o) : t === L && m(e, o))
        }

        function y(t) {
            t[C] = M++, t._state = void 0, t._result = void 0, t._subscribers = []
        }
        ...
        function r(t) {
            if (this[C] = M++, this._result = this._state = void 0, this._subscribers = [], u !== t) {
        ...
        var w, o, v, b, _, A, D, x, S, T, O, E, P, C, k, B, L, M, N, R;
        t.exports = (w = Array.isArray || function(t) {
            return "[object Array]" === Object.prototype.toString.call(t)
        }, b = v = void(o = 0), _ = function(t, e) {
            S[o] = t, S[o + 1] = e, 2 === (o += 2) && (b ? b(n) : P())
        }, t = "undefined" != typeof window ? window : void 0, A = (A = t || {}).MutationObserver || A.WebKitMutationObserver, D = "undefined" == typeof self && "undefined" != typeof process && "[object process]" === {}.toString.call(process), x = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel, S = new Array(1e3), P = void 0, P = D ? function() {
            return process.nextTick(n)
        } : A ? (O = 0, D = new A(n), E = document.createTextNode(""), D.observe(E, {
            characterData: !0
        }), function() {
            E.data = O = ++O % 2
        }) : x ? ((T = new MessageChannel).port1.onmessage = n, function() {
            return T.port2.postMessage(0)
        }) : (void 0 === t ? z : e)(), C = Math.random().toString(36).substring(2), k = void 0, B = 1, L = 2, M = 0, i.prototype._enumerate = function(t) {
            ...
            if (i === c) {
                ...
                o === d && e._state !== k ? this._settledAt(e._state, t, e._result) : "function" != typeof o ? (this._remaining--, this._result[t] = e) : n === R ? (r = new n(u), s ? m(r, a) : h(r, e, o), this._willSettleAt(r, t)) : this._willSettleAt(new n(function(t) {
                    return t(e)
                }), t)
            } else this._willSettleAt(i(e), t)
        }, i.prototype._settledAt = function(t, e, n) {
            var i = this.promise;
            i._state === k && (this._remaining--, t === L ? m(i, n) : this._result[e] = n), 0 === this._remaining && f(i, this._result)
    ...
    o.BrandingDomain = void 0, (E = o.BrandingDomain || (o.BrandingDomain = {}))[E.Neutral = 0] = "Neutral", E[E.Yepi = 1] = "Yepi", E[E.Spele = 2] = "Spele", E[E.Funnygames = 3] = "Funnygames", E[E.Kizi = 4] = "Kizi", E[E.PlayCell = 5] = "PlayCell", E[E.GameCell = 6] = "GameCell", E[E.Bild = 7] = "Bild", E[E.AGame = 8] = "AGame", E[E.Admeen = 9] = "Admeen", E[E.PlayTime = 10] = "PlayTime", E[E.Zigiz = 11] = "Zigiz", p.isBip = function() {
    ...
    function p() {}
    o.UtmTargets = void 0, (E = o.UtmTargets || (o.UtmTargets = {}))[E.splashscreen = 0] = "splashscreen", E[E.logo = 1] = "logo", E[E.facebook = 2] = "facebook", E[E.twitter = 3] = "twitter", E[E.playstore = 4] = "playstore", E[E.appstore = 5] = "appstore", E[E.more_games = 6] = "more_games", E[E.download_game = 7] = "download_game", E[E.walkthrough = 8] = "walkthrough", E[E.disclaimer = 9] = "disclaimer", E[E.highscores = 10] = "highscores", m.getProtocol = function(t) {
        return t ? "https://" : "//"
    ...
    T.getUrlParams = function(t, e) {
        ...
        try {
            ...
            console.log("Could not get url parameters : ", t)
        }
        return n
    }, T.hasBooleanValue = function(t, e) {
        t = T.getUrlParams(t, e);
        return !!t && "true" === t
    ...
    var O = t(function(t, e) {
                    ...
                    ! function() {
                        var c, n, u, h, p, t, f, s, d, l, m, o, r, a, i, g, e, y, w = this || Function("return this")(),
                            v = (t = Date.now || function() {
                                return +new Date
                            }, f = "undefined" != typeof SHIFTY_DEBUG_NOW ? SHIFTY_DEBUG_NOW : t, n = "undefined" != typeof window && (window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || window.mozCancelRequestAnimationFrame && window.mozRequestAnimationFrame) || setTimeout, P.prototype.tween = function(t) {
                                ...
                                var e = this,
                                    ...
                                    i = this._targetState;
                                return D(i, n), this._easing = E(n, t.easing || "linear"), this._filterArgs = [n, this._originalState, i, this._easing], T(this, "tweenCreated"), this
                            ...
                            }, P.prototype.filter = {}, c = P.prototype.formula = {
                                linear: function(t) {
                                    return t
                                }
                            }, A(P, {
                                ...
                                shallowCopy: A,
                                defaults: D,
                                composeEasingObject: E
                            }), "function" == typeof SHIFTY_DEBUG_NOW && (w.timeoutHandler = O), "object" == typeof j ? G.exports = P : void 0 === w.Tweenable && (w.Tweenable = P), P);
                        ...
                        function I(t) {
                            3 === (t = (t = t).replace(/#/, "")).length && (t = (t = t.split(""))[0] + t[0] + t[1] + t[1] + t[2] + t[2]), e[0] = k(t.substr(0, 2)), e[1] = k(t.substr(2, 2)), e[2] = k(t.substr(4, 2));
                            t = e;
                        ...
                        v.shallowCopy(v.prototype.formula, {
                            ...
                            tweenCreated: function(t, e, n, i) {
                                var o, a;
                                C(t), C(e), C(n), this._tokenData = (o = t, a = {}, d.each(o, function(t) {
                                    var r, e, n = o[t];
        ...
        }, P.prototype.setScriptloadProgress = function(t, e) {
            this.circleLoader.animate(.3 * e / t, null, function() {})
        }, P.prototype.setLoadProgress = function(t) {
            var e, n = this;
        ...
        }, P.prototype.setButtonCallback = function(t) {
    ...
    o.Branding = _, o.DebugTools = S, o.Domain = i, o.Hosts = h, o.SplashLoader = E, o.Utils = D, Object.defineProperty(o, "__esModule", {
        value: !0
    })
});